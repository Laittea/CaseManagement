import pytest
from app.models.ml_models import LogisticRegressionModel, DecisionTreeModel, RandomForestModel
...
def test_logistic_regression_fit(models):
    ...
    assert model.predict(X_test).shape[0] == y_test.shape[0], "Prediction output shape mismatch"
