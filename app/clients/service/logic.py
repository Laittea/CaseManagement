...
try:
    ...
    raise ImportError(
        "numpy is required but not installed. Install it using `pip install numpy`."
        ) from e
...
if __name__ == "__main__":
    ...
    sample_data = {
        ...
        "canada_born": "1", "citizen_status": "2", "level_of_schooling": "2", "fluent_english": 
            "3",
        "reading_english_scale": "2", "speaking_english_scale": "2", "writing_english_scale": "3",
        "numeracy_scale": "2", "computer_scale": "3", "transportation_bool": "2", "caregiver_bool": 
            "1",
